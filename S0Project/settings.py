"""
Django settings for S0Project project.
...
SECRET_KEY = '4$xcv!cu8(^2sq6ah&c*a!uzj*drf^o_+(1@j&9(+3e1n7ch+2'
...
WSGI_APPLICATION = 'S0Project.wsgi.application'
